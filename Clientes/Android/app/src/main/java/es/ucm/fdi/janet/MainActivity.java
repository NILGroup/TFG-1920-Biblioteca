...
import es.ucm.fdi.janet.Items.Book;
import es.ucm.fdi.janet.Items.Location;
import es.ucm.fdi.janet.Items.Phone;
import es.ucm.fdi.janet.Items.Email;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Locale locEnglish = new Locale("en", "US");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String initialMessage = "¡Hola! Soy Janet. Puedo buscar libros en la biblioteca de la UCM. También puedo decirte la ubicación, horario, email y teléfono de las bibliotecas. ¡Si lo prefieres, incluso puedes hablarme en inglés!";
        ...
        t = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if(status != TextToSpeech.ERROR){
                    ...
                    if (speech)
                        t.speak(initialMessage, TextToSpeech.QUEUE_FLUSH, null, null);
                }
            }
        });
        ...
        this.newSimpleEntryText(initialMessage, false, "es");
    }
    ...
    private void newObjectEntry(JSONObject resultado) {
        try {
            ...
            String idioma = "es";
            try {
                idioma = resultado.get("idioma").toString();
            } catch (Exception e) { }
            ...
            switch(resultado.get("content-type").toString()) {
                case "list-books":
                    ...
                    newSimpleEntryText(resultado.get("response").toString(),false, idioma);
    ...
    private void newSimpleEntryText(String message, boolean isUser, String lang) {
        LinearLayout linearLayout = (LinearLayout) findViewById(R.id.conversationContainer);
    ...
    private void newSimpleEntryText(String message, boolean isUser) {
        newSimpleEntryText(message, isUser, "es");
    ...
    private class SendAndReceiveTask extends AsyncTask<Void, Void, Boolean>{
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            System.out.println("QUERY: " + query + type);
            ...
            if(!success){
                ...
                try {
                    if (null == user_id || user_id.length() <= 0) {
                        ...
                        user_id = resultado.get("user_id").toString();
